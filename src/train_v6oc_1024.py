...
BEST_MODEL_PATH = "v6oc_1024_best_model.pth"
...
def main():
    ...
    print(f"\nV6OC-1024 Training | λ={LAMBDA_REG} | Focal(α={FOCAL_ALPHA},γ={FOCAL_GAMMA}) | LR={LEARNING_RATE:.0e}")
    ...
    np.save('v6oc_1024_y_true.npy', val_targets)
    np.save('v6oc_1024_y_pred.npy', val_preds)

    print(f"\n{'='*50}")
    print(f"V6OC-1024 Final Results")
    print(f"{'='*50}")
